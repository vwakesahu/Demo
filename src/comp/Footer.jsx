    ...
    <div className="mx-auto px-4 sm:px-6">
      ...
      <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        ...
        <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
          ...
          <p className="text-sm text-gray-600 mb-4">We will try to resolve, just enter your email here.</p>
          <form>
      ...
      <div className="flex items-center justify-center py-4 md:py-8 border-t border-gray-200">
        ...
        <div className="text-sm text-center text-gray-600 mr-4">Thanks for visiting this website 😊. Sending love from our team</div>
